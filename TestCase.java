...
public class TestCase {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < data.length; i++) {
            ...
            /*
            if (path == null) {
                throw new AssertionError("{" + data[i][0] + ", " + data[i][1] + ", -1, -1},");
            } else {
                throw new AssertionError("{" + data[i][0] + ", " + data[i][1] + ", " + path.getStates().size() + ", " + path.getCost() + "},");
            }
            */
            ...
            if (numStates == -1) {
                if (path != null) {
                    throw new AssertionError("no path exists but one was found");
                }
            } else {
                if (path == null) {
                    throw new AssertionError("path exists but none was found");
                }
                ...
                if (numStates != actualNumStates) {
                    throw new AssertionError("path should have " + numStates + " states but had " + actualNumStates);
                }
                if (cost != actualCost) {
                    throw new AssertionError("path should have cost " + cost + " but had " + actualCost);
                }
            }
        }
    }
